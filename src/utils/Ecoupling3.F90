...
nmolec=1
    ...
    subroutine readfile(filename,nstates(nmolec),ncharges(nmolec),xyz1,charge1,poletype1)
...
nmolec=2
    ...
    filename=fname1//fname2//fname3 !piece together filename
    write(6,*) 'Opening file ',filename
    subroutine readfile(filename,nstates(nmolec),ncharges(nmolec),xyz2,charge2,poletype2)
