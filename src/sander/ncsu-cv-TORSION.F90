...
#  include "ncsu-mpi.h"
   ...
   ncsu_assert(cv%type == COLVAR_TORSION)

   ncsu_assert(associated(cv%i))
   ncsu_assert(size(cv%i) == 4)
   ...
   ncsu_assert(cv%i(4) > 0 .and. cv%i(4) <= sander_natoms())
   a4 = 3*cv%i(4) - 2

   ncsu_assert(a1 /= a2 .and. a1 /= a3 .and. a1 /= a4)
   ncsu_assert(a2 /= a3 .and. a2 /= a4)
   ncsu_assert(a3 /= a4)
