...
! Computation dipole moment of atoms
    ...
    select case (qmmm_nml%printdipole)
      case (1)
        ...
        call qm2_calc_dipole(qmmm_nml, qm2_params, qm2_struct, qm2ds, qmmm_struct, qm_cm_coord)
      ...
      case (2)
        ...
        call qm2_calc_dipole(qmmm_nml, qm2_params, qm2_sruct, qm2ds, qmmm_struct, qm_cm_coord)
