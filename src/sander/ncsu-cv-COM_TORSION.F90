...
#  include "ncsu-mpi.h"
        ...
        NCSU_REAL :: cm1(3), cm2(3), cm3(3), cm4(3)

        ncsu_assert(cv%type == COLVAR_COM_TORSION)

        ncsu_assert(associated(cv%i))
        ncsu_assert(size(cv%i) .ge. 7)
...
end module ncsu_cv_COM_TORSION
