...
contains
    ...
    end subroutine allocate_naesmd_module_init
    ...
    end subroutine allocate_naesmd_module
    ...
    end subroutine allocate_naesmd_module2
end module naesmd_module
