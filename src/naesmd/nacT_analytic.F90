...
!
    subroutine new_xstep_dtnact(sim, xxx, yyy, zzz, xs)
        ...
        return
    end subroutine new_xstep_dtnact
!
!********************************************************************
!
!********************************************************************
!
    subroutine new_xstep_dtnact_r3(sim, r, xs)
        ...
        return
    end subroutine new_xstep_dtnact_r3
...
!
    ...
    subroutine nacT_analytic(sim, nact, xstep)
        ...
        return
    end subroutine nacT_analytic

end module nacT_analytic_module!
