...
contains
    ...
    subroutine checkcrossingmiddle(sim, cross)
        ...
        return
    end subroutine checkcrossingmiddle
...
! option 2: check trivial unavoided crossingfor for the current sim%naesmd%state
        return
    end subroutine vmdqtmiddlecalc
    ...
    end subroutine do_trivial_wrap
    ...
    end subroutine quantum_propagation
...
!BTN: removed file coeff-n-before.out. grep this line to undo
    ...
    end subroutine check_ntotcoher
