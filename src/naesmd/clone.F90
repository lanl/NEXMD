...
contains
    ...
    end subroutine clone_real_pointer_1
    ...
    end subroutine clone_real_pointer_2
    ...
    end subroutine clone_real_pointer_3
    ...
    end subroutine clone_real_pointer_4
    ...
    end subroutine clone_int_pointer_1
    ...
    end subroutine clone_int_pointer_2
    ...
    end subroutine clone_logical_pointer_1
    ...
    end subroutine clone_complex_1
    ...
    end subroutine clone_complex_2
    subroutine clone_int_0(old, new)
        integer, intent(in) :: old
        integer, intent(out) :: new
        new = old
    end subroutine clone_int_0
