...
contains
...
#endif
        allocate (a%naesmd)
    end subroutine init0_simulation
    ...
    end subroutine setp_simulation
    ...
    subroutine dav2naesmd_Omega(sim)
        ...
        return
    end subroutine dav2naesmd_Omega
    !
    !********************************************************************
    !
    ...
    subroutine deriv2naesmd_accel(sim)
        ...
        return
    end subroutine deriv2naesmd_accel
    ...
    end subroutine nacR_analytic_wrap
    !
    !********************************************************************
    !
