...
subroutine identify_link_atoms(qmmm_struct, nbona,ib,jb)
...
subroutine position_link_atoms(qmmm_struct, unimaged_coords)
...
subroutine print_link_atom_info(qmmm_struct, qmcoords, atom_type )
...
subroutine adj_mm_link_pair_crd(qmmm_struct, unimaged_coords)
...
subroutine rst_mm_link_pair_crd(qmmm_struct, unimaged_coords)
